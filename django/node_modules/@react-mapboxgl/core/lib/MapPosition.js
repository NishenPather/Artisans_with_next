...
var MapPosition = (_temp = _class = function (_React$Component) {
  ...
  MapPosition.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    if (cameraOptions) {
      map[nextProps.moveMethod]((0, _extend3.default)(cameraOptions, nextProps.moveMethod !== 'jumpTo' ? nextProps.moveAnimationOptions : {}, nextProps.moveMethod === 'flyTo' ? nextProps.moveFlyToOptions : {}));
    }

    if (!(0, _isEqual3.default)(this.props.bbox, nextProps.bbox)) {
      map.fitBounds(nextProps.bbox, (0, _extend3.default)({
        padding: nextProps.padding || 0,
        linear: nextProps.moveMethod !== 'flyTo'
      }, nextProps.moveAnimationOptions ? nextProps.moveAnimationOptions : {}, nextProps.moveMethod === 'flyTo' ? nextProps.moveFlyToOptions : {}));
    }
  };
  ...
  center: _propTypes2.default.oneOfType([_propTypes2.default.arrayOf(_propTypes2.default.number), _propTypes2.default.object]),
  zoom: _propTypes2.default.number,
  minZoom: _propTypes2.default.number,
  maxZoom: _propTypes2.default.number,
  maxBounds: _propTypes2.default.oneOfType([_propTypes2.default.array, _propTypes2.default.object]),
