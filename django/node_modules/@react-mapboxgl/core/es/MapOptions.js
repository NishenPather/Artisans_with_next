...
var MapOptions = (_temp = _class = function (_React$PureComponent) {
  ...
  MapOptions.prototype.componentDidMount = function componentDidMount() {
    ...
    if (!_isUndefined(this.props.showTileBoundaries)) {
      map.showTileBoundaries(this.props.showTileBoundaries);
    }
    if (!_isUndefined(this.props.showCollisionBoxes)) {
      map.showCollisionBoxes(this.props.showCollisionBoxes);
    }
    if (!_isUndefined(this.props.repaint)) {
      map.repaint(this.props.repaint);
    }
    if (!_isUndefined(this.props.rtlTextPlugin)) {
