...
var MapPosition = (_temp = _class = function (_React$Component) {
  ...
  MapPosition.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    if (cameraOptions) {
      map[nextProps.moveMethod](_extend(cameraOptions, nextProps.moveMethod !== 'jumpTo' ? nextProps.moveAnimationOptions : {}, nextProps.moveMethod === 'flyTo' ? nextProps.moveFlyToOptions : {}));
    }

    if (!_isEqual(this.props.bbox, nextProps.bbox)) {
      map.fitBounds(nextProps.bbox, _extend({
  ...
  center: PropTypes.oneOfType([PropTypes.arrayOf(PropTypes.number), PropTypes.object]),
